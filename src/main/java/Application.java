...
public class Application {
	...
	public static void main(String[] args) {
		...
		private static String userEmployeeList;
	
		private static String asList(String string, String string2, String string3, String string4) {
			if (!employeeList.contains(asList)) {
				System.out.println("Please choose your employee from the following list:");
				System.out.println("1. Dr. Jefferson");
				System.out.println("2 Dr. Smith");
				System.out.println("3. Bob RN");
				System.out.println("4. Doni");
				System.out.println("5. Toni");
				System.out.println("6. Goodman");
